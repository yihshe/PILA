...
#         --config saved/mogi/PHYS_VAE_MOGI_C_SMPL/1013_163421_klp0_edge10_kla1_rank4_delta_penalty0/models/config.json \
#         --resume saved/mogi/PHYS_VAE_MOGI_C_SMPL/1013_163421_klp0_edge10_kla1_rank4_delta_penalty0/models/model_best.pth \
