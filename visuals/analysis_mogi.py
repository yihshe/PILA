...
CSV_PATH0 = os.path.join( 
    BASE_PATH, 'PHYS_VAE_MOGI_C_SMPL/1009_112518_rank8_delta_penalty0/models',
...
SAVE_PATH = os.path.join(BASE_PATH, 'PHYS_VAE_MOGI_C_SMPL/1009_112518_rank8_delta_penalty0/models', 'plots')
